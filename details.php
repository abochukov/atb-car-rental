		...
		<div class="news-section">
		   	<div class="container">
		  		<h3>Интересни дестинации</h3>
		   			...
		   			<div class="col-md-2 up wow bounceInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s; "></div>
		   		    <div class="col-md-8 up wow bounceInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s; ">
				                    ...
				                    echo "
				                       <div class='item'>
				                              ...
				                              <div class='caption'>
				                                ...
				                                <p>".$text."</p>
				                                <a class='btn btn-mini' href='news.php'>» Назад</a>
				                              </div>
