  ...
  <div class="header" id="home">
		 ...
		 <div class="content">
			<div class="about-section">
				...
				<div class="col-md-4 about-img wow bounceInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s; " >
						...
						<img src="../images/cars/megane1.jpg" class="img-responsive" alt="/" style="float:right;">
				</div>
				...
				<div class="col-md-4 about-grid wow bounceInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;" >
						<img src="../images/cars/megane2.jpg" class="img-responsive" alt="/" style="float:right;">
				</div>
				
				<div class="col-md-4 about-grid wow bounceInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;" >
						<img src="../images/cars/megane3.jpg" class="img-responsive" alt="/" style="float:right;">
				</div>
	...
	`					</div>
	  ...
	  <div class="up1">
		...
		<div class="up1">
		<div class="up-img">
			<img src="../images/cars/me1.jpg">
		</div>
     <div class="up-text">
		 <a href="#">Renault Megane</a>
