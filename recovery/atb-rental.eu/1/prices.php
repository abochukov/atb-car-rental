	...
	<script>
		$(document).ready(function(){
			$(".options input[type='submit']").click(function() {
				...
				// Proverka dali e silen ili slab sezon
				/*
				...
				*/
				...
				if (days<=0) {
					...
					var sum = (days)*25; //broia dni po 25 euro
					...
					var sum = (days)*20; //broia dni po 20 euro
					var extra1, extra2, extra3, extra4, extra5, extra6;
...
<body>
  <div class="header" id="home">
		 ...
		 <div class="content">
			<div class="about-section">
				...
				<div class="col-md-4 about-grid wow bounceInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;" >
						<img src="../images/cars/swift2.jpg" class="img-responsive" alt="/" style="float:right;">
				</div>
				
				<div class="col-md-4 about-grid wow bounceInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;" >
						<img src="../images/cars/swift4.jpg" class="img-responsive" alt="/" style="float:right;">
				</div>
	...
	<li>lorem,Cras consequat iaculis id vehicula</li>
		...
		<li><p>+359 878 48 84 48</p>
		<p>+359 2 987 24 25</p></li>
		</ul>
		<ul>
	   <li><i class="smartphone"></i></li>
		...
		<li><a href="mailto:example@mail.com">reservation@atb-rental.eu</a>
         <a href="mailto:example@mail.com">office@atb-rental.eu</a></li>
		</ul>
		</div>
		 <div class="clearfix"></div>
		  </div>
      ...
      <ul>
			...
			<li><a href="../services.html">Условия</a></li>
			<li><a href="../products.html">Резервация</a></li>
			<!--<li><a href="blog.html">blog</a></li><label>/</label>-->
			<li><a href="../contact.html">контакти</a></li>
    </ul>
		</div>
